...
public interface PlayerMainHandStackChangeCallback {
    Event<PlayerMainHandStackChangeCallback> EVENT = EventFactory.createArrayBacked(PlayerMainHandStackChangeCallback.class,
            listeners -> (player, serverWorld, itemStack) -> {
                for (PlayerMainHandStackChangeCallback listener : listeners) {
